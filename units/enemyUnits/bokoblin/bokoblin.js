function Bokoblin(board, inventory, behavior) {
  ...
  this.mapSprite = new Sprite(c, 533, 607, 18, 18, "units/enemyUnits/bokoblin/bokoblin_sprite.png", 6, 1);
  this.hpWindowSprite = new Sprite(c, 200, 200, 18, 18, "units/enemyUnits/bokoblin/bokoblinHPWindowSprite.jpg", 6, 1);
}
