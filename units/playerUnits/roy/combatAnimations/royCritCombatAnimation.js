function RoyCritCombatAnimation() {
  ...
  let sprite9 = new Sprite(c, 150, 42, 150, 42, 'units/playerUnits/roy/combatAnimations/spriteSheets/royCritSprite9.png', 2, 3);
  let sprite10 = new Sprite(c, 150, 76, 150, 76, 'units/playerUnits/roy/combatAnimations/spriteSheets/royCritSprite10.png', 2, 5);
  let sprite11 = new Sprite(c, 100, 31, 100, 31, 'units/playerUnits/roy/combatAnimations/spriteSheets/royCritSprite11.png', 2, 7);
  let sprite12 = new Sprite(c, 100, 36, 100, 36, 'units/playerUnits/roy/combatAnimations/spriteSheets/royCritSprite12.png', 2, 7);
